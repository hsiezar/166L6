...
public class EmbeddedSQL {
   ...
   public static void Query1(EmbeddedSQL esql){
      ...
      // ...
       try{
           String query = "SELECT S.sname, COUNT(C.sid) FROM Suppliers S, Catalog C WHERE S.sid = C.sid GROUP BY S.sname";
           //System.out.print("\tEnter cost: $");
           String input = in.readLine();
           query += input;
   ...
   public static void Query2(EmbeddedSQL esql){
      ...
      // ...
       try{
           String query = "SELECT S.sname, COUNT(C.sid) FROM Suppliers S, Catalog C WHERE S.sid = C.sid GROUP BY S.sname HAVING COUNT(C.sid) > 2";
           //System.out.print("\tEnter cost: $");
           String input = in.readLine();
           query += input;
   ...
   public static void Query3(EmbeddedSQL esql){
      ...
      // ...
       try{
           String query = "SELECT S.sname, COUNT(C.pid) AS cp FROM Suppliers S, catalog C WHERE S.sid = C.sid AND S.sid IN ((SELECT C1.sid FROM Catalog C1, Parts P1 WHERE C1.pid = P1.pid AND P1.color ='Green') EXCEPT (SELECT C2.sid FROM Catalog C2, Parts P2 WHERE C2.pid = P2.pid AND P2.color != 'Green')) GROUP BY S.sname";
           //System.out.print("\tEnter cost: $");
           String input = in.readLine();
           query += input;
   ...
   public static void Query4(EmbeddedSQL esql){
      ...
      // ...
       try{
           String query = "SELECT T.sname, MAX(C.cost) FROM ((SELECT C1.sid, S1.sname FROM Catalog C1, Parts P1, Suppliers S1 WHERE C1.pid = P1.pid AND C1.sid = S1.sid AND P1.color = 'Red') INTERSECT (SELECT C2.sid, S2.sname FROM Catalog C2, Parts P2, Suppliers S2 WHERE C2.pid = P2.pid AND C2.sid = S2.sid AND P2.color = 'Green')) T, Catalog C WHERE C.sid = T.sid GROUP BY T.sname";
           //System.out.print("\tEnter cost: $");
           String input = in.readLine();
           query += input;
